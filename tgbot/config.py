...
# Image path
PHOTOS_BLUR = os.path.join(BASE_DIR, f'tgbot/photos_blur')
PHOTOS_UNBLUR = os.path.join(BASE_DIR, f'tgbot/photos_unblur')
...
WEBHOOK_PATH = config('WEBHOOK_PATH', cast=str, default='/tgbot')
...
# API
QIWI_WALLET_TOKEN = config('QIWI_WALLET_TOKEN', cast=str, default='5432')

# Payment cost
SEARCH_COST = config('SEARCH_COST', cast=int, default=1)
SHOW_COST = config('SHOW_COST', cast=int, default=1)
